jQuery(document).ready(function ($) {
	...
	var allEditableElements = '.wpforms-field-label, .wpforms-field-number input[type=number], .wpforms-field input[type=text],.wpforms-field input[type=email],.wpforms-field input[type=tel], .wpforms-smart-phone-field .wpforms-field-email input[type=email], .wpforms-field-select select, .wpforms-field select, .wpforms-field-payment-checkbox ul, .wpforms-field-radio ul, .wpforms-field .wpforms-field-description, .wpforms-field-payment-radio ul, .wpforms-field-checkbox ul, .wpforms-submit-container input[type=submit], .wpforms-field-url input[type=url], .wpforms-field-textarea textarea, .wpforms-container .wpforms-container-full, .wpforms-description, .wpforms-title, .wpforms-head-container, .wpforms-field input[type=password], button.wpforms-page-button, .wpforms-field-payment-multiple ul' ;


	var input_fields = ['.wpforms-field-container .wpforms-field input[type=text]', '.wpforms-field-container .wpforms-field input[type=email]', '.wpforms-field-container input[type=tel]','.wpforms-field-phone input', '.wpforms-field-container input[type=url]', '.wpforms-field-container input[type=password]','.wpforms-field-container input[type=number]', '.wpforms-smart-phone-field'];

	// var sub_labels = ['.gfield .ginput_complex label'];

	var button = ['.wpforms-submit-container input[type=submit], .wpforms-field .wpforms-page-button'];
	...
	$('<span class="customize-partial-edit-shortcut sfwf-partial-radio-shortcut">' + editRadioButton + '</span>').insertBefore('.wpforms-field-payment-multiple ul');
	...
	$('<span class="customize-partial-edit-shortcut sfwf-partial-checkbox-shortcut">' + editCheckboxButton + '</span>').insertBefore('.wpforms-field-payment-checkbox ul');

	$('<span class="customize-partial-edit-shortcut sfwf-partial-checkbox-shortcut">' + editCheckboxButton + '</span>').insertBefore('.wpforms-field-payment-radio ul');
	...
	$(allEditableElements).on('mouseenter', function () {
		if (!$(this).parents('.sfwf-live-edit-disabled').length) {
			...
			$('.wpforms-container .customize-partial-edit-shortcut').css('display', 'none');
			...
			if ($(this).hasClass('wpforms-title') || $(this).hasClass('wpforms-description')) {
	...
	$('.sfwf-partial-sectiondescription-shortcut button').on('click', function () {
		var data = {
			'form_id': formId,
