...
?>
        ...
        <a class="nav-tab nav-tab-pro open-sticky-pro-dialog" href="#" data-pro-feature="tab">Get Sticky PRO</a>
			...
			<div class="tabs-content">
              ...
              <tr>
								<th scope="row"><label for="sa_bg_color"><?php _e('Background Color When Sticky:','sticky-menu-or-anything-on-scroll'); ?></label> <span tooltip="<?php _e('Element\'s background color when it\'s sticky','sticky-menu-or-anything-on-scroll'); ?>"><span class="dashicons dashicons-editor-help"></span></a></th>
								<td>
              ...
              <tr>
								<th scope="row"><label for="custom_css"><?php _e('Custom CSS:','sticky-menu-or-anything-on-scroll'); ?></label> <span tooltip="<?php _e('Custom CSS that\'s added to the element when it\'s sticky','sticky-menu-or-anything-on-scroll'); ?>"><span class="dashicons dashicons-editor-help"></span></a></th>
								<td>
